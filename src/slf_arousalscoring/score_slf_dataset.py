...
from slf_arousalscoring.train import set_gpu_visibility
...
def score_slf_ds(
    ...
    scorer_ckpt = module.training.get_model(model_config)
    scorer_ckpt.load_weights(scorer_ckpt_dir)
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--tf-config-path', type=str,
        help='Path to the tensorflow config file, if Tensorflow model is used')
