...
You can copy the URL for cloning from Code -> Clone. Then, create a new python 3.10 environment with your tool of choice, e.g.:

```console
conda create -n <envname> python==3.10
```

and activate the environment. After that, install the dependencies with pip in the project root folder:
...
```console
python src/slf_arousalscoring/train.py --tf-use-gpu --visible-device 1 \
